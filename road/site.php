<?php
	...
	$app->get("/checkout", function(){
		...
		User::verifyLogin(false); // false para não ir para a tela de login do Admin
	...
	// rota ESQUECI A SENHA (não é usuario administrativo, é o cliente)
	...
	$app->post("/profile/change-password", function(){
		...
		if ($_POST['new_pass'] !== $_POST['new_pass_confirm']) {
			...
			User::setError("A nova senha difere da inserida na confirmação.");
			header("Location: /profile/change-password");
			exit;
